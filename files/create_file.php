...
<section>
    <div class="container py-5">
        <a class="btn btn-primary btn-sm" href="index.php" role="button">Manage file</a>
        <div class="row">
            <div class="col-lg-6 col-md-6">
                ...
                if (isset($_POST['save'])) {
                    ...
                    if ($title != "" && $description != "" &&  $file_link="" && $status != "") {

                        // Insert the task into the database
                        $created_at = date("Y-m-d H:i:s");
                        $updated_at = $created_at;

                        $insert = "INSERT INTO files (title, description, file_link, status, created_at, updated_at) 
                        ...
                        if ($result) {
                            ...
                            echo "<div class='alert alert-danger'>There was an error adding the file</div>";
                        }
                    } else {
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="description" class="form-label">file_link </label>
                        <input name="file_link " class="form-control" id="file_link ">
                    </div>
                    <div class="mb-3">
